...
import { updateStart, updateSuccess,upadateFailure, deleteUserFailure, deleteUserSuccess, deleteUserStart, signOutSuccess } from '../redux/user/userSlice'
...
function DashProfile() {
    ...
    const uploadeImage= async () => {
        ...
        uploadTask.on(
            ...
            (error)=>{
                setImageFileUploadError('Could not upload Image (Image size should be less than 2 MB)');
    ...
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
            ...
            <div className='relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full' onClick={()=>filePickerRef.current.click()}>
                {imageFileUploadingProgress  && (<CircularProgressbar value={imageFileUploadingProgress || 0} 
